      ...
      sections: [
        {
          ...
          items: [
            ...
            { name: 'Register New Audio', href: '/mypage/audios/new' },
            { name: 'Create New AudioNFT', href: '/mypage/audio-nfts/new' },
        ...
        },
        {
          ...
          items: [{ name: 'Marketplace', href: '/marketplace' }],
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          id: 'public-altars',
          name: 'Public Altars',
          items: [{ name: 'All Altars', href: '/altars' }],
        },
      ],
    },
    {
      ...
      sections: [
        {
          id: 'creators',
          name: 'Creators',
          items: [{ name: 'All Creators', href: '/users' }],
        },
      ],
    },
  ],
